            ...
            <c:if test="${requestScope.alunos.size() == 0}">
                ...
                <c:forEach items="${requestScope.alunos}" var="a">
                    <tr>
                        ...
                        <td><a href="control?ac=MarcaAlaPraticaAluno&id=${a.matricula}"> <button type="button" class="btn btn-primary">Práticas</button> </a></td>
                        <td><a href="control?ac=MarcaAlaTeoricaAluno&id=${a.matricula}"> <button type="button" class="btn btn-info">Teóricas</button> </a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
